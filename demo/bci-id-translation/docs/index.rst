...
This documentation was generated from the https://github.com/rsundqvist/id-translation-project on Sunday, 26 Nov 2023,
...
Example
-------
Using ``id_translation.translate`` with a temporary translation :class:`~id_translation.offline.Format`.
Input file: :download:`transactions.csv`.
